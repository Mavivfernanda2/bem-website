...
<div class="space-y-6">
    ...
    <!-- PAGE TITLE -->
    <div>
        <h1 class="text-2xl font-bold text-white">Tambah Berita</h1>
        <p class="text-sm text-slate-400">Tambah berita baru</p>
    </div>
            ...
            <div>
                ...
                <textarea name="excerpt"
                          ...
                          class="w-full rounded-xl bg-slate-800
                                 border border-slate-700
                                 text-slate-100 px-4 py-2.5
                                 focus:ring-2 focus:ring-emerald-500 focus:outline-none">{{ old('excerpt') }}</textarea>
            ...
            <div>
                ...
                <textarea name="content"
                          ...
                          class="w-full rounded-xl bg-slate-800
                                 border border-slate-700
                                 text-slate-100 px-4 py-2.5
                                 focus:ring-2 focus:ring-emerald-500 focus:outline-none">{{ old('content') }}</textarea>
            </div>
